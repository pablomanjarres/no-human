...
function CoverageBar({ share, home }: { share: number; home: boolean }) {
  return (
    <div aria-hidden className="relative h-[10px] w-full min-w-[120px] border border-cab-600 bg-cab-950">
      <span
      ...
      <span
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(90deg, transparent 0 calc(10% - 1px), color-mix(in oklab, var(--color-cab-950) 60%, transparent) calc(10% - 1px) 10%)",
        }}
      />
    </div>
  );
